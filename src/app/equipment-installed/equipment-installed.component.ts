...
@Component({
  selector: 'app-equipment-installed',
  templateUrl: './equipment-installed.component.html',
  styleUrl: './equipment-installed.component.css'
})
export class EquipmentInstalledComponent {
  @ViewChild(MatTable)
